...
function loadSpecials() {
  ...
  if (_specials.length === 0) {
    _specials = [
      { id: 1, title: 'Happy Hour', description: 'Half-price appetizers and $5 draft beers', days: ['Mon','Tue','Wed','Thu','Fri'], startTime: '16:00', endTime: '18:00' },
      { id: 2, title: 'Taco Tuesday', description: '$2 tacos and $3 margaritas all day', days: ['Tue'], startTime: '11:00', endTime: '22:00' },
      { id: 3, title: 'Sunday Brunch', description: 'Bottomless mimosas with any brunch entree', days: ['Sun'], startTime: '10:00', endTime: '14:00' }
    ];
    _specialIdCounter = 3;
  }
